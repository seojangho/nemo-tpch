...
public final class Schemas {
  ...
  public static final Schema STORE_SALES_SCHEMA =
    Schema.builder()
      .addNullableField("ss_sold_date_sk", Schema.FieldType.DECIMAL)
      .addNullableField("ss_sold_time_sk", Schema.FieldType.DECIMAL)
      .addNullableField("ss_item_sk", Schema.FieldType.DECIMAL)
      .addNullableField("ss_customer_sk", Schema.FieldType.STRING)
      .addNullableField("ss_cdemo_sk", Schema.FieldType.DECIMAL)
      .addNullableField("ss_hdemo_sk", Schema.FieldType.DECIMAL)
      .addNullableField("ss_addr_sk", Schema.FieldType.DECIMAL)
      .addNullableField("ss_store_sk", Schema.FieldType.DECIMAL)
      .addNullableField("ss_promo_sk", Schema.FieldType.DECIMAL)
      .addNullableField("ss_ticket_number", Schema.FieldType.DECIMAL)
      .addNullableField("ss_quantity", Schema.FieldType.DECIMAL)
  ...
  public static final Schema DATE_DIM_SCHEMA =
    Schema.builder()
      .addNullableField("d_date_sk", Schema.FieldType.DECIMAL)
      .addNullableField("d_date_id", Schema.FieldType.STRING)
      .addNullableField("d_date", Schema.FieldType.STRING)
      .addNullableField("d_month_seq", Schema.FieldType.DECIMAL)
      .addNullableField("d_week_seq", Schema.FieldType.DECIMAL)
      .addNullableField("d_quarter_seq", Schema.FieldType.DECIMAL)
      .addNullableField("d_year", Schema.FieldType.DECIMAL)
      .addNullableField("d_dow", Schema.FieldType.DECIMAL)
      .addNullableField("d_moy", Schema.FieldType.DECIMAL)
      .addNullableField("d_dom", Schema.FieldType.DECIMAL)
      .addNullableField("d_qoy", Schema.FieldType.DECIMAL)
      .addNullableField("d_fy_year", Schema.FieldType.DECIMAL)
      .addNullableField("d_fy_quarter_seq", Schema.FieldType.DECIMAL)
      .addNullableField("d_fy_week_seq", Schema.FieldType.DECIMAL)
      ...
      .addNullableField("d_first_dom", Schema.FieldType.DECIMAL)
      .addNullableField("d_last_dom", Schema.FieldType.DECIMAL)
      .addNullableField("d_same_day_ly", Schema.FieldType.DECIMAL)
      .addNullableField("d_same_day_lq", Schema.FieldType.DECIMAL)
  ...
  public static final Schema ITEM_SCHEMA =
    Schema.builder()
      .addNullableField("i_item_sk", Schema.FieldType.DECIMAL)
      ...
      .addNullableField("i_brand_id", Schema.FieldType.DECIMAL)
      .addNullableField("i_brand", Schema.FieldType.STRING)
      .addNullableField("i_class_id", Schema.FieldType.DECIMAL)
      .addNullableField("i_class", Schema.FieldType.STRING)
      .addNullableField("i_category_id", Schema.FieldType.DECIMAL)
      .addNullableField("i_category", Schema.FieldType.STRING)
      .addNullableField("i_manufact_id", Schema.FieldType.DECIMAL)
      ...
      .addNullableField("i_manager_id", Schema.FieldType.DECIMAL)
      .addNullableField("i_product_name", Schema.FieldType.STRING)
      .build();

  public static final Schema INVENTORY_SCHEMA =
    Schema.builder()
      .addNullableField("inv_date_sk", Schema.FieldType.DECIMAL)
      .addNullableField("inv_item_sk", Schema.FieldType.DECIMAL)
      .addNullableField("inv_warehouse_sk", Schema.FieldType.DECIMAL)
      .addNullableField("inv_quantity_on_hand", Schema.FieldType.DECIMAL)
      .build();

  public static final Schema CATALOG_SALES_SCHEMA =
    Schema.builder()
      .addNullableField("cs_sold_date_sk", Schema.FieldType.DECIMAL)
      .addNullableField("cs_sold_time_sk", Schema.FieldType.DECIMAL)
      .addNullableField("cs_ship_date_sk", Schema.FieldType.DECIMAL)
      .addNullableField("cs_bill_customer_sk", Schema.FieldType.DECIMAL)
      .addNullableField("cs_bill_cdemo_sk", Schema.FieldType.DECIMAL)
      .addNullableField("cs_bill_hdemo_sk", Schema.FieldType.DECIMAL)
      .addNullableField("cs_bill_addr_sk", Schema.FieldType.DECIMAL)
      .addNullableField("cs_ship_customer_sk", Schema.FieldType.DECIMAL)
      .addNullableField("cs_ship_cdemo_sk", Schema.FieldType.DECIMAL)
      .addNullableField("cs_ship_hdemo_sk", Schema.FieldType.DECIMAL)
      .addNullableField("cs_ship_addr_sk", Schema.FieldType.DECIMAL)
      .addNullableField("cs_call_center_sk", Schema.FieldType.DECIMAL)
      .addNullableField("cs_catalog_page_sk", Schema.FieldType.DECIMAL)
      .addNullableField("cs_ship_mode_sk", Schema.FieldType.DECIMAL)
      .addNullableField("cs_warehouse_sk", Schema.FieldType.DECIMAL)
      .addNullableField("cs_item_sk", Schema.FieldType.DECIMAL)
      .addNullableField("cs_promo_sk", Schema.FieldType.DECIMAL)
      .addNullableField("cs_order_number", Schema.FieldType.DECIMAL)
      .addNullableField("cs_quantity", Schema.FieldType.DECIMAL)
  ...
  public static final Schema CUSTOMER_DS_SCHEMA =
    Schema.builder()
      .addNullableField("c_customer_sk", Schema.FieldType.DECIMAL)
      .addNullableField("c_customer_id", Schema.FieldType.STRING)
      .addNullableField("c_current_cdemo_sk", Schema.FieldType.DECIMAL)
      .addNullableField("c_current_hdemo_sk", Schema.FieldType.DECIMAL)
      .addNullableField("c_current_addr_sk", Schema.FieldType.DECIMAL)
      .addNullableField("c_first_shipto_date_sk", Schema.FieldType.DECIMAL)
      .addNullableField("c_first_sales_date_sk", Schema.FieldType.DECIMAL)
      ...
      .addNullableField("c_birth_day", Schema.FieldType.DECIMAL)
      .addNullableField("c_birth_month", Schema.FieldType.DECIMAL)
      .addNullableField("c_birth_year", Schema.FieldType.DECIMAL)
  ...
  public static final Schema PROMOTION_SCHEMA =
    Schema.builder()
      .addNullableField("p_promo_sk", Schema.FieldType.DECIMAL)
      .addNullableField("p_promo_id", Schema.FieldType.STRING)
      .addNullableField("p_start_date_sk", Schema.FieldType.DECIMAL)
      .addNullableField("p_end_date_sk", Schema.FieldType.DECIMAL)
      .addNullableField("p_item_sk", Schema.FieldType.DECIMAL)
      .addNullableField("p_cost", Schema.FieldType.FLOAT)
      .addNullableField("p_response_target", Schema.FieldType.DECIMAL)
  ...
  public static final Schema CUSTOMER_DEMOGRAPHIC_SCHEMA =
    Schema.builder()
      .addNullableField("cd_demo_sk", Schema.FieldType.DECIMAL)
      ...
      .addNullableField("cd_purchase_estimate", Schema.FieldType.DECIMAL)
      .addNullableField("cd_credit_rating", Schema.FieldType.STRING)
      .addNullableField("cd_dep_count", Schema.FieldType.DECIMAL)
      .addNullableField("cd_dep_employed_count", Schema.FieldType.DECIMAL)
      .addNullableField("cd_dep_college_count", Schema.FieldType.DECIMAL)
      .build();

  public static final Schema WEB_SALES_SCHEMA =
    Schema.builder()
      .addNullableField("ws_sold_date_sk", Schema.FieldType.DECIMAL)
      .addNullableField("ws_sold_time_sk", Schema.FieldType.DECIMAL)
      .addNullableField("ws_ship_date_sk", Schema.FieldType.DECIMAL)
      .addNullableField("ws_item_sk", Schema.FieldType.DECIMAL)
      .addNullableField("ws_bill_customer_sk", Schema.FieldType.DECIMAL)
      .addNullableField("ws_bill_cdemo_sk", Schema.FieldType.DECIMAL)
      .addNullableField("ws_bill_hdemo_sk", Schema.FieldType.DECIMAL)
      .addNullableField("ws_bill_addr_sk", Schema.FieldType.DECIMAL)
      .addNullableField("ws_ship_customer_sk", Schema.FieldType.DECIMAL)
      .addNullableField("ws_ship_cdemo_sk", Schema.FieldType.DECIMAL)
      .addNullableField("ws_ship_hdemo_sk", Schema.FieldType.DECIMAL)
      .addNullableField("ws_ship_addr_sk", Schema.FieldType.DECIMAL)
      .addNullableField("ws_web_page_sk", Schema.FieldType.DECIMAL)
      .addNullableField("ws_web_site_sk", Schema.FieldType.DECIMAL)
      .addNullableField("ws_ship_mode_sk", Schema.FieldType.DECIMAL)
      .addNullableField("ws_warehouse_sk", Schema.FieldType.DECIMAL)
      .addNullableField("ws_promo_sk", Schema.FieldType.DECIMAL)
      .addNullableField("ws_order_number", Schema.FieldType.DECIMAL)
      .addNullableField("ws_quantity", Schema.FieldType.DECIMAL)
